<template>
    <div class="container px-8 mt-10 ">
      ...
      <div class="mx-2 mb-6 text-2xl font-semibold text-black">Hotel</div>
                          ...
                          <tr v-for="(value,index) in data" :key="value.name">
                              ...
                              <td
                                  class="px-6 py-4 text-sm font-medium leading-5 text-right whitespace-no-wrap border-b border-gray-200">
                                   <router-link :to="{ name:'hotelEdit',params:{id:value.id}}" class="text-indigo-400 hover:text-indigo-900" > Edit</router-link>
                              </td>
                          </tr>
